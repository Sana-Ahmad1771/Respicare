    ...
    >
            ...
            {[FaFacebookF, FaXTwitter, AiFillInstagram, IoLogoLinkedin].map(
              (Icon, idx) => (
                <a
                  key={idx}
                  href="#"
                  className="w-10 h-10 flex items-center justify-center bg-primary/80 text-white rounded-lg hover:bg-primary-light transition"
                >
                  <Icon size={18} />
                </a>
              )
      ...
      >
        <div className="max-w-[1600px] mx-auto px-6 lg:px-16 xl:px-24 flex flex-col lg:flex-row justify-between items-center gap-3 text-center">
          <p>
            © {new Date().getFullYear()} Respicare Medical. All rights
            reserved.
          </p>
